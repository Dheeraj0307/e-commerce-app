        ...
        <div className="formLeftSide">
          <div className="para">
            ...
            <form action="https://formspree.io/f/xdkovpzv" method="POST" className="formik-form">
              ...
              <textarea className="input-block" rows={4} name="message" placeholder="Enter your Thoughts" style={{ resize: 'none' }} ></textarea>
